...
<form method='POST' action='http://localhost:9090/ProjetInfo2b/Servlet'>
...
<body style="margin: 0px">
    ...
    <tr>
            <td><input type="text" maxlength="10" id="dateDebut"
                onfocus="view_microcal(true,dateDebut,microcal,-1,0);"
